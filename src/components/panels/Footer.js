        ...
        <div id="footer-inner">
          <div id="footer-left">
            <div className="footer-menu">
              ...
              <ul>
                <PanelLink text="Link Shortening" to="#" hoverColor="primary" />
                <PanelLink text="Branded Links" to="#" hoverColor="primary" />
                <PanelLink text="Link Shortening" to="#" hoverColor="primary" />
                <PanelLink text="Analytics" to="#" hoverColor="primary" />
              </ul>
            </div>
            <div className="footer-menu">
              <label>Resources</label>
              <ul>
                <PanelLink text="Blog" to="#" hoverColor="primary" />
                <PanelLink text="Developers" to="#" hoverColor="primary" />
                <PanelLink text="Support" to="#" hoverColor="primary" />
              </ul>
            </div>
            <div className="footer-menu">
              <label>Company</label>
              <ul>
                <PanelLink text="About" to="#" hoverColor="primary" />
                <PanelLink text="Our Team" to="#" hoverColor="primary" />
                <PanelLink text="Careers" to="#" hoverColor="primary" />
                <PanelLink text="Contact" to="#" hoverColor="primary" />
              </ul>
            </div>
          </div>
          <ul id="footer-social-media">
            <SocialLink media="facebook" to="#" />
            <SocialLink media="twitter" to="#" />
            <SocialLink media="pinterest" to="#" />
            <SocialLink media="instagram" to="#" />
          </ul>
        </div>
      </footer>
    );
